...
const ContactUs = () => {
  ...
  const validateName = (name) => {
    name = name.trim(); // Trim the input to remove leading and trailing spaces
  ...
  const validateEmail = (email) => {
    email = email.trim(); // Trim the input to remove leading and trailing spaces
    const emailRegex = /^[^\s@]+@[^\s@]+\.com$/; // Only allows .com after @domain
    if (!email) return "Email is required.";
    if (!emailRegex.test(email)) return "Please enter a valid email address with '.com'.";
    return "";
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://formspree.io/f/mdovkgeq", {
      method: "POST",
      headers: {
  ...
  return (
    <div
      className="w-full bg-shape text-white flex items-center flex-col h-full scroll-mt-[100px] rounded-xl  px-10  min-h-[90vh]"
      id="contact"
    >
      <div className="flex flex-col items-center justify-center  gap-2">
      <h4 className="text-xl font-bold text-customPurple text-center py-10 px-10">Contact Us</h4>
  ...
  src={service}
  alt="Contact Us"
  className="floating w-full max-w-[500px] aspect-[500/300]"
  width="500"
  height="300"
  loading="lazy"
/>
        ...
        <div className="max-md:w-full flex items-center flex-col justify-center text-black">
          <div className="bg-gradient-to-r from-secondary via-white to-secondary p-1 rounded-xl">
            <form
              className="flex flex-col border rounded-xl bg-white p-10 gap-5 sm:min-w-[400px] items-center"
              onSubmit={handleSubmit}
              style={{ borderColor: '#3801b6' }}
            >
              <div className="flex flex-col gap-2 w-[250px]">
                ...
                <input
                  ...
                  value={name}
                  onChange={(e) => setName(e.target.value.trim())} // Trim spaces on input
                />
              ...
              <div className="flex flex-col gap-2 w-[250px]">
                ...
                <input
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value.trim())} // Trim spaces on input
                />
              ...
              <div className="flex flex-col gap-2 w-[250px]">
                ...
                <textarea
                  ...
                  name="comment"
                  id="comment"
                  placeholder="Interested in a demo? Let us know your questions!"
                  value={comment}
